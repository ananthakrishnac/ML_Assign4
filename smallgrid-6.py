...
def draw_gridworld(utility_list, policy_list, iteration_list, name_list, figname, row, col):
    ...
    for index, utility in enumerate(utility_list):
        #utility = np.flip(utility,axis=0)
...
def main():
    ...
    q_utilitys, q_policys, iteration, q_runtimes = run_qlearning(P, R, gamma, [50000, 500000000], row, col, s_obstacle,s_terminal, s_penalty)
    draw_gridworld(q_utilitys, q_policys, iteration, ['Q','Q','Q','Q'], 'q-5B.png',row, col)
