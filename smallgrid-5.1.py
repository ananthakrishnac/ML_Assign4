...
def main():
    ...
    draw_gridworld(vi_utilitys, vi_policys, vi_iterations, ['VI','VI','VI','VI'], '7.maze-vi-1.png',row, col)
    
    pi_utilitys, pi_policys, pi_iterations, pi_runtimes = run_pi(P, R, gamma,
                                                                  [5,20,50,75], 
                                                                  epsilon,row,col)
    
    draw_gridworld(pi_utilitys, pi_policys, pi_iterations, ['PI','PI','PI','PI'], '8.maze-pi-1.png',row, col)
    ...
    draw_gridworld(q_utilitys, q_policys, iteration, ['Q','Q','Q','Q'], '9.maze-q-p1-1.png',row, col)
